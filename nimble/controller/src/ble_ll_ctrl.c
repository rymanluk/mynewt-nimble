...
ble_ll_ctrl_proc_unk_rsp(struct ble_ll_conn_sm *connsm, uint8_t *dptr, uint8_t *rspdata)
{
    ...
    case BLE_LL_CTRL_LENGTH_REQ:
        ...
        BLE_LL_CLEAR_FEATURE(connsm, BLE_LL_FEAT_DATA_LEN_EXT);
        break;
    ...
    case BLE_LL_CTRL_SLAVE_FEATURE_REQ:
        ...
        BLE_LL_CLEAR_FEATURE(connsm, BLE_LL_FEAT_SLAVE_INIT);
        break;
    case BLE_LL_CTRL_CONN_PARM_REQ:
        BLE_LL_CLEAR_FEATURE(connsm, BLE_LL_FEAT_CONN_PARM_REQ);
    ...
    case BLE_LL_CTRL_PING_REQ:
        ...
        BLE_LL_CLEAR_FEATURE(connsm, BLE_LL_FEAT_LE_PING);
        break;
#if (BLE_LL_BT5_PHY_SUPPORTED ==1)
